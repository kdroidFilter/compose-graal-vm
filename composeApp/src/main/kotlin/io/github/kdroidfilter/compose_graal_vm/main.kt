...
fun main() {
    if (isNativeImage) {
        // Force Metal L&F to avoid AquaLookAndFeel loading osxui (unsupported in native image)
        System.setProperty("swing.defaultlaf", "javax.swing.plaf.metal.MetalLookAndFeel")

        // Set java.home to the executable's directory so Skiko can find libjawt.dylib
